...
static const struct xpad_device {
  ...
  u8 flags;
    ...
    {0x0351, 0x1000, "CRKD LP Blueberry Burst Pro Edition (Xbox)", 0,
     XTYPE_XBOX360},
    ...
    {0x03f0, 0x08B6, "HyperX Clutch Gladiate", MAP_SHARE_BUTTON,
     XTYPE_XBOXONE}, /* v2 */
    ...
    {0x044f, 0xd01e, "ThrustMaster, Inc. ESWAP X 2 ELDEN RING EDITION", 0,
     XTYPE_XBOXONE},
    ...
    {0x045e, 0x0719, "Xbox 360 Wireless Receiver", MAP_DPAD_TO_BUTTONS,
     XTYPE_XBOX360W},
    {0x045e, 0x0b00, "Microsoft X-Box One Elite 2 pad", MAP_PADDLES,
     XTYPE_XBOXONE},
    {0x045e, 0x0b0a, "Microsoft X-Box Adaptive Controller", MAP_PROFILE_BUTTON,
     XTYPE_XBOXONE},
    ...
    {0x0738, 0x4530, "Mad Catz Universal MC2 Racing Wheel and Pedals", 0,
     XTYPE_XBOX},
    ...
    {0x0738, 0x45ff, "Mad Catz Beat Pad (w/ Handle)", MAP_DPAD_TO_BUTTONS,
     XTYPE_XBOX},
    {0x0738, 0x4716, "Mad Catz Wired Xbox 360 Controller", 0, XTYPE_XBOX360},
    {0x0738, 0x4718, "Mad Catz Street Fighter IV FightStick SE", 0,
     XTYPE_XBOX360},
    ...
    {0x0738, 0x4758, "Mad Catz Arcade Game Stick", MAP_TRIGGERS_TO_BUTTONS,
     XTYPE_XBOX360},
    {0x0738, 0x4a01, "Mad Catz FightStick TE 2", MAP_TRIGGERS_TO_BUTTONS,
     XTYPE_XBOXONE},
    {0x0738, 0x6040, "Mad Catz Beat Pad Pro", MAP_DPAD_TO_BUTTONS, XTYPE_XBOX},
    {0x0738, 0x9871, "Mad Catz Portable Drum", 0, XTYPE_XBOX360},
    {0x0738, 0xb726, "Mad Catz Xbox controller - MW2", 0, XTYPE_XBOX360},
    {0x0738, 0xb738, "Mad Catz MVC2TE Stick 2", MAP_TRIGGERS_TO_BUTTONS,
     XTYPE_XBOX360},
    {0x0738, 0xbeef, "Mad Catz JOYTECH NEO SE Advanced GamePad", 0,
     XTYPE_XBOX360},
    {0x0738, 0xcb02, "Saitek Cyborg Rumble Pad - PC/Xbox 360", 0,
     XTYPE_XBOX360},
    ...
    {0x0d2f, 0x0002, "Andamiro Pump It Up pad", MAP_DPAD_TO_BUTTONS,
     XTYPE_XBOX},
    {0x0db0, 0x1901, "Micro Star International Xbox360 Controller for Windows",
     0, XTYPE_XBOX360},
    ...
    {0x0e6f, 0x015c, "PDP Xbox One Arcade Stick", MAP_TRIGGERS_TO_BUTTONS,
     XTYPE_XBOXONE},
    {0x0e6f, 0x015d, "PDP Mirror's Edge Official Wired Controller for Xbox One",
     0, XTYPE_XBOXONE},
    ...
    {0x0e6f, 0x02a2, "PDP Wired Controller for Xbox One - Crimson Red", 0,
     XTYPE_XBOXONE},
    {0x0e6f, 0x02a4, "PDP Wired Controller for Xbox One - Stealth Series", 0,
     XTYPE_XBOXONE},
    ...
    {0x0e6f, 0x02ad, "PDP Wired Controller for Xbox One - Stealth Series", 0,
     XTYPE_XBOXONE},
    ...
    {0x0f0d, 0x00c5, "Hori Fighting Commander ONE", MAP_TRIGGERS_TO_BUTTONS,
     XTYPE_XBOXONE},
    {0x0f0d, 0x00dc, "HORIPAD FPS for Nintendo Switch", MAP_TRIGGERS_TO_BUTTONS,
     XTYPE_XBOX360},
    {0x0f0d, 0x0151, "Hori Racing Wheel Overdrive for Xbox Series X", 0,
     XTYPE_XBOXONE},
    {0x0f0d, 0x0152, "Hori Racing Wheel Overdrive for Xbox Series X", 0,
     XTYPE_XBOXONE},
    {0x0f0d, 0x01b2, "HORI Taiko No Tatsujin Drum Controller", MAP_SHARE_BUTTON,
     XTYPE_XBOXONE},
    ...
    {0x10f5, 0x7008, "Turtle Beach Recon Controller", MAP_SHARE_BUTTON,
     XTYPE_XBOXONE},
    {0x10f5, 0x7073, "Turtle Beach Stealth Ultra Controller", MAP_SHARE_BUTTON,
     XTYPE_XBOXONE},
    ...
    {0x1bad, 0xf039, "Mad Catz MvC2 TE", MAP_TRIGGERS_TO_BUTTONS,
     XTYPE_XBOX360},
    {0x1bad, 0xf03a, "Mad Catz SFxT Fightstick Pro", MAP_TRIGGERS_TO_BUTTONS,
     XTYPE_XBOX360},
    {0x1bad, 0xf03d, "Street Fighter IV Arcade Stick TE - Chun Li",
     MAP_TRIGGERS_TO_BUTTONS, XTYPE_XBOX360},
    {0x1bad, 0xf03e, "Mad Catz MLG FightStick TE", MAP_TRIGGERS_TO_BUTTONS,
     XTYPE_XBOX360},
    {0x1bad, 0xf03f, "Mad Catz FightStick SoulCaliber", MAP_TRIGGERS_TO_BUTTONS,
     XTYPE_XBOX360},
    ...
    {0x1bad, 0xf502, "Hori Real Arcade Pro.VX SA", MAP_TRIGGERS_TO_BUTTONS,
     XTYPE_XBOX360},
    ...
    {0x20bc, 0x5125, "Beitong KP20A/KP40A Controller", 0, XTYPE_XBOX360,
     FLAG_FORCE_INIT},
    {0x20bc, 0x5126, "Beitong KP20A Controller", 0, XTYPE_XBOX360,
     FLAG_FORCE_INIT},
    {0x20bc, 0x5127, "Beitong KP20A/KP40A Controller", 0, XTYPE_XBOX360,
     FLAG_FORCE_INIT},
    {0x20bc, 0x5128, "Beitong KP20A Controller", 0, XTYPE_XBOX360,
     FLAG_FORCE_INIT},
    {0x20bc, 0x512f, "Beitong KP70A Controller", 0, XTYPE_XBOX360,
     FLAG_FORCE_INIT},
    {0x20bc, 0x5130, "Beitong KP70A Controller", 0, XTYPE_XBOX360,
     FLAG_FORCE_INIT},
    {0x20bc, 0x5133, "Beitong KP50B Controller", 0, XTYPE_XBOX360,
     FLAG_FORCE_INIT},
    {0x20bc, 0x5134, "Beitong KP50B Controller", 0, XTYPE_XBOX360,
     FLAG_FORCE_INIT},
    {0x20bc, 0x5145, "Beitong KP40A/KP40B Controller", 0, XTYPE_XBOX360,
     FLAG_FORCE_INIT},
    {0x20bc, 0x5146, "Beitong KP40A/KP40B Controller", 0, XTYPE_XBOX360,
     FLAG_FORCE_INIT},
    {0x20bc, 0x5149, "Beitong KP50C Controller", 0, XTYPE_XBOX360,
     FLAG_FORCE_INIT},
    {0x20bc, 0x514a, "Beitong KP50C Controller", 0, XTYPE_XBOX360,
     FLAG_FORCE_INIT},
    {0x20bc, 0x5150, "Beitong KP50D Controller", 0, XTYPE_XBOX360,
     FLAG_FORCE_INIT},
    {0x20bc, 0x5151, "Beitong KP50D Controller", 0, XTYPE_XBOX360,
     FLAG_FORCE_INIT},
    {0x20bc, 0x5152, "Beitong KP50E Controller", 0, XTYPE_XBOX360,
     FLAG_FORCE_INIT},
    {0x20bc, 0x5153, "Beitong KP50E Controller", 0, XTYPE_XBOX360,
     FLAG_FORCE_INIT},
    {0x20bc, 0x5154, "Beitong KP40D Controller", 0, XTYPE_XBOX360,
     FLAG_FORCE_INIT},
    {0x20bc, 0x5155, "Beitong KP40D Controller", 0, XTYPE_XBOX360,
     FLAG_FORCE_INIT},
    {0x20bc, 0x5158, "Beitong KP20D Controller", 0, XTYPE_XBOX360,
     FLAG_FORCE_INIT},
    {0x20bc, 0x5159, "Beitong KP20D Controller", 0, XTYPE_XBOX360,
     FLAG_FORCE_INIT},
    {0x20bc, 0x515b, "Beitong KP40D Controller (White)", 0, XTYPE_XBOX360,
     FLAG_FORCE_INIT},
    {0x20bc, 0x515c, "Beitong KP40D Controller (White)", 0, XTYPE_XBOX360,
     FLAG_FORCE_INIT},
    {0x20bc, 0x515d, "Beitong KP40F Controller (White)", 0, XTYPE_XBOX360,
     FLAG_FORCE_INIT},
    {0x20bc, 0x515e, "Beitong KP40F Controller (White)", 0, XTYPE_XBOX360,
     FLAG_FORCE_INIT},
    {0x20bc, 0x515f, "Beitong KP70A Controller", 0, XTYPE_XBOX360,
     FLAG_FORCE_INIT},
    {0x20bc, 0x5160, "Beitong KP70A Controller", 0, XTYPE_XBOX360,
     FLAG_FORCE_INIT},
    {0x20bc, 0x5169, "Beitong KP40F Controller (Black)", 0, XTYPE_XBOX360,
     FLAG_FORCE_INIT},
    {0x20bc, 0x516a, "Beitong KP40F Controller (Black)", 0, XTYPE_XBOX360,
     FLAG_FORCE_INIT},
    {0x20d6, 0x2001, "BDA Xbox Series X Wired Controller", 0, XTYPE_XBOXONE},
    {0x20d6, 0x2009, "PowerA Enhanced Wired Controller for Xbox Series X|S", 0,
     XTYPE_XBOXONE},
    {0x20d6, 0x2064, "PowerA Wired Controller for Xbox", MAP_SHARE_BUTTON,
     XTYPE_XBOXONE},
    {0x20d6, 0x281f, "PowerA Wired Controller For Xbox 360", 0, XTYPE_XBOX360},
    {0x20d6, 0x400b, "PowerA FUSION Pro 4 Wired Controller", MAP_SHARE_BUTTON,
     XTYPE_XBOXONE},
    {0x20d6, 0x890b, "PowerA MOGA XP-Ultra Controller", MAP_SHARE_BUTTON,
     XTYPE_XBOXONE},
    ...
    {0x24c6, 0x5502, "Hori Fighting Stick VX Alt", MAP_TRIGGERS_TO_BUTTONS,
     XTYPE_XBOX360},
    {0x24c6, 0x5503, "Hori Fighting Edge", MAP_TRIGGERS_TO_BUTTONS,
     XTYPE_XBOX360},
    {0x24c6, 0x5506, "Hori SOULCALIBUR V Stick", 0, XTYPE_XBOX360},
    {0x24c6, 0x550d, "Hori GEM Xbox controller", 0, XTYPE_XBOX360},
    {0x24c6, 0x550e, "Hori Real Arcade Pro V Kai 360", MAP_TRIGGERS_TO_BUTTONS,
     XTYPE_XBOX360},
    ...
    {0x2dc8, 0x3106, "8BitDo Ultimate Wireless / Pro 2 Wired Controller", 0,
     XTYPE_XBOX360},
    ...
    {0x2e24, 0x0423, "Hyperkin DuchesS Xbox One pad", MAP_SHARE_BUTTON,
     XTYPE_XBOXONE},
    ...
    {0x366c, 0x0005, "ByoWave Proteus Controller", MAP_SHARE_BUTTON,
     XTYPE_XBOXONE, FLAG_DELAY_INIT},
...
#define XPAD_XBOXONE_VENDOR_PROTOCOL(vend, pr)                              \
  .match_flags = USB_DEVICE_ID_MATCH_VENDOR | USB_DEVICE_ID_MATCH_INT_INFO, \
  .idVendor = (vend), .bInterfaceClass = USB_CLASS_VENDOR_SPEC,             \
  .bInterfaceSubClass = 71, .bInterfaceProtocol = (pr)
#define XPAD_XBOXONE_VENDOR(vend) {XPAD_XBOXONE_VENDOR_PROTOCOL((vend), 208)}
 ...
 */
static const u8 xboxone_power_on[] = {GIP_CMD_POWER, GIP_OPT_INTERNAL, GIP_SEQ0,
                                      GIP_PL_LEN(1), GIP_PWR_ON};
 ...
 * Bluetooth mode.
 */
static const u8 xboxone_s_init[] = {GIP_CMD_POWER, GIP_OPT_INTERNAL, GIP_SEQ0,
                                    0x0f, 0x06};
 ...
 */
static const u8 extra_input_packet_init[] = {0x4d, 0x10, 0x01,
                                             0x02, 0x07, 0x00};
 ...
 */
static const u8 xboxone_hori_ack_id[] = {GIP_CMD_ACK,
                                         GIP_OPT_INTERNAL,
                                         GIP_SEQ0,
                                         GIP_PL_LEN(9),
                                         0x00,
 ...
 */
static const u8 xboxone_led_on[] = {
    GIP_CMD_LED, GIP_OPT_INTERNAL, GIP_SEQ0, GIP_PL_LEN(3),
 ...
 */
static const u8 xboxone_auth_done[] = {GIP_CMD_AUTHENTICATE,
                                       GIP_OPT_INTERNAL,
                                       GIP_SEQ0,
                                       GIP_PL_LEN(2),
                                       0x01,
...
static const u8 xboxone_rumblebegin_init[] = {
    GIP_CMD_RUMBLE, 0x00, GIP_SEQ0, GIP_PL_LEN(9), 0x00, GIP_MOTOR_ALL, 0x00,
...
static const u8 btp_probe_response_packet[] = {GIP_CMD_ANNOUNCE, 0x8, GIP_SEQ0};
 ...
 */
static void xpad_process_packet(struct usb_xpad* xpad,
                                u16 cmd,
                                unsigned char* data) {
  ...
  if (!(xpad->mapping & MAP_STICKS_TO_NULL)) {
    /* left stick */
    input_report_abs(dev, ABS_X, (__s16)le16_to_cpup((__le16*)(data + 12)));
    input_report_abs(dev, ABS_Y, ~(__s16)le16_to_cpup((__le16*)(data + 14)));

    /* right stick */
    input_report_abs(dev, ABS_RX, (__s16)le16_to_cpup((__le16*)(data + 16)));
    input_report_abs(dev, ABS_RY, ~(__s16)le16_to_cpup((__le16*)(data + 18)));
  }
...
static void xpad360_process_packet(struct usb_xpad* xpad,
   ...
   */
  if (!(xpad->mapping & MAP_DPAD_TO_BUTTONS) || xpad->xtype == XTYPE_XBOX360W) {
    input_report_abs(dev, ABS_HAT0X, !!(data[2] & 0x08) - !!(data[2] & 0x04));
    input_report_abs(dev, ABS_HAT0Y, !!(data[2] & 0x02) - !!(data[2] & 0x01));
  }
 ...
 *
 */
static void xpad360w_process_packet(struct usb_xpad* xpad,
                                    u16 cmd,
                                    unsigned char* data) {
  struct input_dev* dev;
  bool present;
...
static void xpadone_process_packet(struct usb_xpad* xpad,
  ...
  if (data[0] == GIP_CMD_VIRTUAL_KEY) {
    ...
    if (xpad->delay_init && !xpad->delayed_init_done) {
      ...
      if (error)
        dev_warn(&xpad->dev->dev, "unable to start delayed input: %d\n", error);
    }
  } else if (data[0] ==
             GIP_CMD_INPUT) { /* The main valid packet type for inputs */
    /* menu/view buttons */
    ...
    if (xpad->mapping & MAP_DPAD_TO_BUTTONS) {
      ...
      input_report_abs(dev, ABS_HAT0X, !!(data[5] & 0x08) - !!(data[5] & 0x04));
      input_report_abs(dev, ABS_HAT0Y, !!(data[5] & 0x02) - !!(data[5] & 0x01));
    }
    ...
    if (!(xpad->mapping & MAP_STICKS_TO_NULL)) {
      /* left stick */
      input_report_abs(dev, ABS_X, (__s16)le16_to_cpup((__le16*)(data + 10)));
      input_report_abs(dev, ABS_Y, ~(__s16)le16_to_cpup((__le16*)(data + 12)));

      /* right stick */
      input_report_abs(dev, ABS_RX, (__s16)le16_to_cpup((__le16*)(data + 14)));
      input_report_abs(dev, ABS_RY, ~(__s16)le16_to_cpup((__le16*)(data + 16)));
    }

    /* triggers left/right */
    if (xpad->mapping & MAP_TRIGGERS_TO_BUTTONS) {
      input_report_key(dev, BTN_TL2, (__u16)le16_to_cpup((__le16*)(data + 6)));
      input_report_key(dev, BTN_TR2, (__u16)le16_to_cpup((__le16*)(data + 8)));
    } else {
      input_report_abs(dev, ABS_Z, (__u16)le16_to_cpup((__le16*)(data + 6)));
      input_report_abs(dev, ABS_RZ, (__u16)le16_to_cpup((__le16*)(data + 8)));
    }
...
static int xpad_init_output(struct usb_interface* intf,
...
static void xpadone_ack_mode_report(struct usb_xpad* xpad, u8 seq_num) {
  struct xpad_output_packet* packet = &xpad->out_packets[XPAD_OUT_CMD_IDX];
  static const u8 mode_report_ack[] = {GIP_CMD_ACK,
                                       GIP_OPT_INTERNAL,
                                       GIP_SEQ0,
                                       GIP_PL_LEN(9),
                                       0x00,
...
static int xpad_play_effect(struct input_dev* dev,
                            void* data,
...
static void xpad_led_set(struct led_classdev* led_cdev,
  ...
  struct xpad_led* xpad_led = container_of(led_cdev, struct xpad_led, led_cdev);
...
static int xpad_start_input(struct usb_xpad* xpad) {
  ...
  if (xpad->xtype == XTYPE_XBOX360) {
    ...
    error = usb_control_msg_recv(
        xpad->udev, 0,
        /* bRequest */ 0x01,
        /* bmRequestType */
        USB_TYPE_VENDOR | USB_DIR_IN | USB_RECIP_INTERFACE,
        /* wValue */ 0x100,
        /* wIndex */ 0x00, dummy, sizeof(dummy), 25, GFP_KERNEL);
    if (error)
      dev_warn(&xpad->dev->dev, "unable to receive magic message: %d\n", error);
  }
...
static int xpad_init_input(struct usb_xpad* xpad) {
  ...
  if (xpad->mapping & MAP_TRIGGERS_TO_BUTTONS) {
    for (i = 0; xpad_btn_triggers[i] >= 0; i++)
      input_set_capability(input_dev, EV_KEY, xpad_btn_triggers[i]);
  } else {
